  ...
  return (
    <footer className="flex w-full flex-col items-center gap-20 bg-transparent px-6 py-8 sm:px-14 md:px-20">
      ...
      <div className="flex w-full flex-col items-center justify-between gap-8 text-center  md:flex-row md:justify-between lg:mx-auto lg:max-w-7xl">
        <span className="text-foreground">©2023 Alisher Sodiqov</span>
        <div className="flex gap-8">
          ...
          >
            <FaTelegram className="text-2xl text-accent transition-colors duration-150 hover:text-accent-foreground" />
          </a>
          <a
          ...
          >
            <GrInstagram className="text-2xl text-accent transition-colors duration-150 hover:text-accent-foreground" />
          </a>
        </div>
      </div>
    </footer>
